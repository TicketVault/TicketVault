					...
					<div class="12u">
						<section class="box">
                            ...
                            <ul class="actions vertical small">
                            	<li> <a href="eventProfile(editMode).php">#Edit Your Profile</a></li>
                            </ul>
		...
		<div class="us_contentBox">
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                ...
                <tr>
                  ...
                  <td width="80%" align="left" bgcolor="#FFFFFF">
                  <input name="first name" type="text" value="<?php echo $row['Price']; ?>" class="formBorder" readonly/>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td width="80%" align="left" bgcolor="#FFFFFF">
                  <input name="last name" type="text" value="<?php echo $row['Detail']; ?>" class="formBorder" readonly/>
                  </td>
                </tr>
